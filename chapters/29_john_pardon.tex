...
\subsection{Informal}
John Pardon (born 1989, Chapel Hill, NC) was recognized for ``revolutionary, groundbreaking results in geometry and topology'' that solve deep problems about shapes, surfaces, tangled loops, and the long-term behavior of dynamic systems. His work ranges from measuring how badly a knot can be tangled to questions about the geometry underlying string theory.
