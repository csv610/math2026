...
\section{The Problem}
Take a rubber band and stretch it into the shape of a donut---a torus---submerged in water. The soap film that forms on its surface will try to minimize its total curvature, spreading itself as smoothly as possible. But not all donut shapes are equally smooth: some are more wrinkly, others more rounded. The question is: \emph{what is the least wrinkly a donut-shaped surface can be?}

More precisely, mathematicians measure the ``wrinkliness'' of a surface by integrating the square of its mean curvature over the entire surface. This quantity---called the \emph{Willmore energy}---stays the same no matter how you stretch or bend the surface through space (it is \emph{conformally invariant}). The conjecture, posed by Thomas Willmore in 1965, is that no donut shape can have Willmore energy below $2\pi^2$---and that the optimal shape is the \emph{Clifford torus}, a perfectly symmetric donut that lives naturally in four-dimensional space.
