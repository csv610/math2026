% Chapter 16: The Willmore Conjecture and the Lawson Conjecture
\let\LocalMacro\relax

\chapter{The Willmore Conjecture and the Lawson Conjecture}
...
\subsection{The Willmore Energy}
...
\subsection{The Lawson Conjecture}
For minimal surfaces in $S^3$, a related problem:

\begin{conjecture}[Lawson, 1970]
The only embedded minimal torus in $S^3$ is the Clifford torus (up to rigid motions).
\end{conjecture}

Lawson \cite{lawson1970} had classified all minimal tori in $S^3$ as a one-parameter family, but only the Clifford torus is embedded.
...
\subsection{The Lawson Classification \cite{lawson1970}}
Lawson showed that minimal tori in $S^3$ form a one-parameter family. The Clifford torus is the unique embedded one.

\section{The Discovery}

\subsection{The Willmore Conjecture: Marques and Neves \cite{marquesneves2014}}
...
\subsection{The Lawson Conjecture: Brendle \cite{brendle2013}}
...
\begin{enumerate}
\item \textbf{Simon's identity}: A sharp integral inequality relating the second fundamental form to the metric.
\item \textbf{Maximum principle}: A clever application of the Omori-Yau maximum principle to a quantity involving the second fundamental form.
\item \textbf{Rigidity}: Show that equality forces the second fundamental form to be that of the Clifford torus.
\end{enumerate}
...
2013 & Brendle proves Lawson conjecture \\

2014 & Marques-Neves win Ramanujan Prize; Brendle wins Fields Medal \\
\bottomrule
\end{tabularx}
