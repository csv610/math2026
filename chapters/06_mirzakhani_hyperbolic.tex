...
\section{The Problem}
A hyperbolic surface is a surface equipped with a Riemannian metric of constant negative curvature. The simplest example is the hyperbolic plane $\mathbb{H}^2$. Compact hyperbolic surfaces exist in any genus $g \geq 2$ by the uniformization theorem.

Maryam Mirzakhani asked several deep questions about the geometry and topology of the moduli space of hyperbolic surfaces:

\begin{enumerate}
\item How many simple closed geodesics of length at most $L$ exist on a hyperbolic surface, as $L \to \infty$?
\item What is the volume of the moduli space of hyperbolic surfaces with respect to the Weil--Petersson metric?
\item How do geodesics behave on hyperbolic surfaces?
\end{enumerate}

These questions connected hyperbolic geometry, Teichm\"uller theory, and ergodic theory in unexpected ways.
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{diagrams/weil_petersson_recursive.pdf}
\caption{The recursive structure of Weil--Petersson volumes: each volume $V_{g,n}$ can be expressed as a sum of products of lower-dimensional volumes.}
\label{fig:wp_recursive}
\end{figure}
