...
\subsection{Informal}
Some surfaces curve inward like a saddle everywhere, rather than outward like a sphere. These hyperbolic surfaces come in countless variations, and Maryam Mirzakhani wanted to understand the ``space of all possible versions'' of such a surface---a kind of map that lists every shape a given surface could take. She figured out how to measure the size of this shape-collection and discovered surprising formulas connecting loops on surfaces to the overall geometry, blending ideas from completely different branches of mathematics.
