...
\subsection{Informal}
In 1981, Robert Langlands and Diana Shelstad formulated the \emph{Fundamental Lemma} as a crucial conjecture in the trace formula, a central tool in the Langlands program \cite{langlands1987}.

The trace formula is a deep identity relating two sides of an equation:
\begin{itemize}
\item \textbf{Geometric side}: Counts orbits of group actions (orbital integrals)
\item \textbf{Spectral side}: Counts representations (trace of operators)
\end{itemize}

The Fundamental Lemma asserts that certain orbital integrals on \emph{endoscopic groups} are equal. Despite its technical statement, it is the linchpin connecting the geometric and spectral sides of the trace formula.
