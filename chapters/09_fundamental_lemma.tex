...
\subsection{Informal}
A big goal in modern number theory is to connect two very different ways of studying symmetry: one based on shapes and motions, the other based on waves and vibrations. A formula called the trace formula tries to link these two viewpoints, but it only works if a certain key identity holds true. That identity, called the Fundamental Lemma, was guessed in 1981 and for decades nobody could prove it. In 2008, Ngo Bao Chau finally did, using deep geometric ideas that nobody had thought to apply to the problem.
