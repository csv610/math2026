...
In two dimensions, the answer is easy: a simple closed curve (like an oval) always divides the plane into an inside and an outside---this is the Jordan Curve Theorem, proved in 1905. In dimensions five and above, Stephen Smale proved in 1961 that simply connected closed manifolds are always spheres. The real mystery is dimension three: our intuition about 3D shapes is far richer than in any other dimension, and the tools that worked elsewhere simply broke down.
...
By the time Perelman solved it, mathematicians had already settled the conjecture in higher dimensions: Stephen Smale proved it for five or more dimensions in 1961, and Michael Freedman solved the four-dimensional case in 1982. The three-dimensional case remained stubbornly open because our intuition about 3D shapes is far richer than in higher dimensions, and the tools that worked elsewhere simply broke down.
