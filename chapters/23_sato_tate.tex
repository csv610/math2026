...
For elliptic curves with complex multiplication (CM curves), like $y^2 = x^3 - x$, the distribution was proved by Deuring in 1941---the Frobenius traces follow a specific arcsine law. The open case was \emph{non-CM} curves, where the distribution follows the Sato--Tate density $\frac{2}{\pi}\sin^2\theta$. Taylor, Harris, Shepherd-Barron, and Clozel proved this in 2008--2011 using automorphic forms and potential automorphy.
