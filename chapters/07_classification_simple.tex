...
\subsection{Informal}
Just as every whole number can be broken down into prime factors, every symmetry group can be broken into fundamental ``atoms'' that cannot be simplified further. The great achievement of twentieth-century algebra was to produce a complete list of these atoms. Hundreds of mathematicians worked on this over four decades, and the final answer turns out to include several infinite families of symmetries plus exactly 26 oddball groups that belong to no family at all.
