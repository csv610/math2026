...
In two dimensions, the answer is easy: a simple closed curve (like an oval) always divides the plane into an inside and an outside---this is the Jordan Curve Theorem, proved in 1905. The real mystery is dimension three: our intuition about 3D shapes is far richer than in any other dimension, and the tools that worked in other dimensions simply broke down.
