...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{diagrams/sphere_packing_comparison.pdf}
\caption{Sphere packing densities across dimensions. Viazovska (2016) proved optimality for dimensions 8 and 24 using modular forms, building on the Cohn--Kumar linear programming framework.}
