...
\subsection{Informal}
We know how tightly spheres can be packed in a line, on a flat surface, and in ordinary three-dimensional space. But what about in four dimensions, eight dimensions, or even twenty-four dimensions---spaces we cannot visualize? In 2016, Maryna Viazovska cracked open two long-standing cases of this problem, proving that certain highly symmetric arrangements are the absolute best you can do in eight and twenty-four dimensions. Her proofs were strikingly short and elegant compared to the massive computations needed for lower dimensions.
