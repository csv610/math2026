...
\subsection{Informal}
Prime numbers are the building blocks of arithmetic, yet their spacing is wildly unpredictable. On average, primes get farther apart as numbers grow, but sometimes two primes appear right next to each other, like 11 and 13. Are there infinitely many such ``twin'' pairs? Nobody knows for sure, but in 2013 Yitang Zhang proved something remarkable: no matter how far you go out along the number line, you will always eventually find two primes separated by no more than a fixed gap. This was the first real progress on a question that had been open for centuries.
