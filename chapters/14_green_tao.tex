...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{diagrams/green_tao_transference.pdf}
\caption{The Green--Tao transference principle: the primes are dominated by a pseudorandom measure, allowing Szemer\'edi's theorem to transfer from dense sets to the primes.}
\label{fig:green_tao}
\end{figure}
