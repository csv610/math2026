...
When only one exponent is fixed, the problem is much easier. Euler proved in 1770 that $x^2 - y^3 = \pm 1$ has only the solution $3^2 - 2^3 = 1$ (and $2^3 - 3^2 = -1$). Lebesgue proved in 1850 that $x^2 - y^n = 1$ has no solutions for $n \ge 3$. The hard part was allowing \emph{both} exponents to vary simultaneously, which Mihăilescu accomplished in 2002 using sophisticated tools from cyclotomic fields.
The conjecture was proposed in 1844 and verified by computer for all exponents up to very large bounds. Various partial results were obtained over the decades, including cases where one exponent was fixed. In 1976, Tijdeman proved that for any solution, the exponents must be bounded. This reduced the problem to checking finitely many cases, but the actual proof required sophisticated new ideas.
