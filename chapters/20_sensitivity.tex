...
\section{The Problem}
Imagine you are asked a yes-or-no question about a long string of coin flips---say, ``is the number of heads even?'' If you flip one coin, the answer might change or it might not. The \emph{sensitivity} of the question is the maximum number of coins that, when flipped simultaneously, could change the answer. A closely related notion---\emph{block sensitivity}---asks the same question but for \emph{groups} of coins flipped together.

The sensitivity conjecture, open for 27 years, asked whether these two measures of complexity are always polynomially related: if a question is simple in one sense, must it also be simple in the other? This may sound like a technical question about computer science, but it touches deep issues about how we measure the complexity of logical and computational processes.
