...
\subsection{Informal}
For thousands of years, people have wanted to know: is this number prime, or can it be broken down into smaller pieces? Testing this by trying every possible divisor works but becomes impossibly slow for huge numbers. Faster shortcuts existed, but they were only best-guess tests that could occasionally be wrong. The big question was: can we always tell for sure whether a number is prime, both quickly and without any chance of error? This puzzle remained open for 40 years until it was finally solved in 2002.
...
\subsection{What Was Novel: The AKS Insight}
...
\subsection{Student-Friendly Summary}
