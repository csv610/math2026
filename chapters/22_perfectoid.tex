...
\subsection{Informal}
In number theory, mathematicians often describe the same mathematical object using two completely different ``languages''---one rooted in algebra, the other in geometry. For decades, there was no good way to translate between them, which meant that powerful tools on one side couldn't be brought to bear on problems stated on the other.
