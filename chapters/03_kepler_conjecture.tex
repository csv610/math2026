...
\section{The Problem}
In 1611, Johannes Kepler observed that when stacking cannonballs in a pyramid, each ball rests in the hollow formed by four balls below. He conjectured that this arrangement (called \emph{face-centered cubic} or FCC packing) achieves the highest possible density among all sphere packings in three dimensions.
