...
\subsection{Informal}
Jacob Tsimerman (born 1988, Russian-born Canadian) was recognized for settling one of the central questions about \emph{Shimura varieties}---geometric objects that encode deep symmetries connecting number theory and geometry. His work brings together three fields that had previously developed largely on their own.

Tsimerman's favorite metaphor captures the spirit of his work: \emph{if these geometric objects could vibrate like physical objects, each resonant frequency would correspond to a specific number-theory puzzle.} Proving theorems about them thus amounts to understanding the full ``spectrum'' of those puzzles.
