...
Marcus, Spielman, and Srivastava introduced \emph{interlacing families of polynomials}. Instead of trying to find the best partition directly, study the *expected characteristic polynomial* of a random signing of the matrix. If the roots of this expected polynomial interlace with the roots of a known polynomial, then there must exist a specific signing whose characteristic polynomial has all roots bounded appropriately. This converts a combinatorial existence problem into a statement about polynomial roots---a far more tractable question. The proof introduced multivariate polynomials, barrier functions, and a recursive argument showing that rank-one updates preserve the interlacing property.
